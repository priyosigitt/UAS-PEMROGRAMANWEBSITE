...
<div class="form-group">
    ...
    <div class="col-md-5">
        ...
        value="<?php echo $produk->ukuran?>">
    </div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">Warna Produk</label>
    <div class="col-md-5">
        <input type="text" name="warna" class="form-control" placeholder="Warna Produk"
        value="<?php echo $produk->warna?>">
    </div>
</div>
<div class="form-group">
    <label class="col-md-2 control-label">Keterangan Produk</label>
    <div class="col-md-10">
        <textarea name="keterangan_produk" class="form-control" placeholder="Keterangan Produk" id="editor"><?php echo  $produk->keterangan_produk?></textarea>
    </div>
</div>
<div class="form-group">
