...
<div class="form-group">
    ...
    <div class="col-md-5">
        ...
        value="<?php echo set_value('ukuran')?>">
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-md-10">
        <textarea name="keterangan_produk" class="form-control" placeholder="Keterangan Produk" id="editor"><?php echo set_value('keterangan_produk')?></textarea>
    </div>
</div>
<div class="form-group">
